export default {
  ...
  database: {
    titles: {
      ...
      textures: 'Textury',
      files: 'Soubory',
      add_contributor: 'Přidat nového přispěvatele',
      ...
      change_contributor: 'Upravit přispěvatele',
    ...
    subtitles: {
      ...
      pack: 'Resource Packy',
      contributor: 'Uživatel',
      select_contributor_type: 'Vyber role uživatele',
      search: 'Vyhledat',
    ...
    labels: {
      anonymous: 'Anonym',
      anonymous_explain: 'Pokud je zatrženo, jméno uživatele bude zobrazeno jako "Anonym" a jeho skin nebude viditelný. Může být změněno pouze administrátory!',
      ...
      add_new_contributor: 'Přidat nového uživatele',
      ...
      contributor_type: 'Role uživatele',
      ...
      select_texture_type: 'Vybrat druh textury',
      username: 'Uživatelské jméno',
      uuid: 'UUID Minecraft profilu',
      texture_name: 'Jméno textury',
      texture_type: 'Druh textury',
    ...
    hints: {
      ...
      warning_path: 'Momentálně je třeba využití vytvořit předtím, než se k němu přidají cesty. Přidávání cest před přidáním využití je plánováno.',
  ...
  gallery: {
    ...
    loading_message: {
      general: 'Načítám…',
      textures: 'Nahrávám textury…',
      paths: 'Nahrávám cesty k texturám…',
      uses: 'Nahrávám využití textur…',
      contribution: 'Získávám příspěvky…',
      contributors: 'Získávám přispěvatele…',
