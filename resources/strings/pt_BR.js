...
export default {
	...
	database: {
		...
		hints: {
			...
			warning_path:
				"Uso precisa ser criado antes de adicionar caminhos a ele (no momento não é bem suportado e um pouco falho), adicionar caminho antes de criar o uso é planejado.",
